 ...
 */
class datos_agente extends fs_controller
{
    public $agente;
    public $agentes;
    public $cargos;
    ...
    public function __construct() {
        parent::__construct(__CLASS__, 'Datos Agente', 'nomina', FALSE, FALSE, FALSE);
    }
